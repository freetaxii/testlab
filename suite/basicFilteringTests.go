...
func (s *Suite) basicFilteringTestsObjectsRO() {
	...
	s.testFT01([]objects.Indicator{allIndicators[4], allIndicators[5]})
	s.testFT02([]objects.Indicator{allIndicators[0], allIndicators[1], allIndicators[2], allIndicators[3], allIndicators[4], allIndicators[5]})
	s.testFT03([]objects.Indicator{allIndicators[0], allIndicators[5]})
	s.testFT04([]objects.Indicator{allIndicators[4], allIndicators[5]})
	s.testFT05([]objects.Indicator{allIndicators[0], allIndicators[4], allIndicators[5]})
	s.testFT06([]objects.Indicator{allIndicators[1]})
	s.testFT07([]objects.Indicator{allIndicators[0], allIndicators[2], allIndicators[4], allIndicators[5]})
	s.testFT08([]objects.Indicator{allIndicators[4]})
	s.testFT09([]objects.Indicator{allIndicators[4], allIndicators[5]})
...
*/
func (s *Suite) testFT01(indicators []objects.Indicator) {
...
*/
func (s *Suite) testFT02(indicators []objects.Indicator) {
...
the read-only collection. There should be two returned.
*/
func (s *Suite) testFT03(indicators []objects.Indicator) {
...
the read-only collection. There should be two returned.
*/
func (s *Suite) testFT04(indicators []objects.Indicator) {
...
*/
func (s *Suite) testFT05(indicators []objects.Indicator) {
...
*/
func (s *Suite) testFT06(indicators []objects.Indicator) {
...
*/
func (s *Suite) testFT07(indicators []objects.Indicator) {
...
*/
func (s *Suite) testFT08(indicators []objects.Indicator) {
...
are returned from the read-only collection. There should be four returned.
*/
func (s *Suite) testFT09(indicators []objects.Indicator) {
...
*/
func (s *Suite) testFT10(indicators []objects.Indicator) {
...
*/
func (s *Suite) testFilteringResponse(indicators []objects.Indicator) {
	if s.Verbose {
